...
Ogni oggetto appartiene necessariamente ad una _Classe_, che rappresenta il suo _Tipo_ e determina la struttura del suo stato ed il codice che opera su tale stato.
...
Note: `private` non significa irraggiungibile: significa soltanto non accessibile sintatticamente. Vedremo che ci sono altri metodi.
